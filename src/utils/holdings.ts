/**
 * Holdings for ML-bought tokens. Used by auto-redeem service.
 */
...
/** Reduce holdings (e.g. partial sell). Clamps to 0. Returns actual amount reduced. */
...
/** Get current shares for a token in a market. */
